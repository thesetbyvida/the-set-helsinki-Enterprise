...
export function PayrollPage(){
  ...
  return <div className="payroll-page">
    ...
    <div className="panel payroll-footnote no-print">Base h = worked + paid S + VL. Monthly contracts use the employee's fixed Monthly Salary as Base €. Ref. €/h is used for percentage-based premiums; if a monthly employee has no hourly rate, it is derived from monthly salary and contracted 3-week hours. VV is tracked separately. Sunday/holiday uses a non-duplicated 100% premium. Overtime is calculated against each full 3-week rota period; 0-hour contracts do not generate threshold overtime automatically.</div>
  </div>
}
