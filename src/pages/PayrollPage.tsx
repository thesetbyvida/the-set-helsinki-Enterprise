...
export function PayrollPage(){
  ...
  return <div className="payroll-page">
    <div className="panel payroll-toolbar no-print"><div><h2>{t.payroll}</h2><p className="muted">Payroll PRO · Phase 4.5 history · period locking · stable snapshots</p></div><div className="payroll-controls">
    ...
    <div className="panel payroll-rates no-print"><div><h3>{t.payrollRates||"Payroll rates"}</h3><p className="muted">Phase 4.5 keeps 4.4 TES calculations and adds historical payroll snapshots. A closed period always displays the saved payroll, even if employee rates or settings change later.</p></div><div className="payroll-rate-grid">
    ...
    <div className="panel payroll-footnote no-print">Phase 4.5: close a completed payroll period to save an immutable historical snapshot. While closed, rota shifts and payroll adjustments inside the period are blocked by Supabase RLS. Reopening restores editing. CSV and Print/PDF always export the currently displayed live or historical data.</div>
  </div>
}
